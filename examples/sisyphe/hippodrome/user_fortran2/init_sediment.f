...
!
        DO I=1,NPOIN
          RATIO_SAND(1,1,I) = 0.25D0
          RATIO_SAND(2,1,I) = 0.25D0
          RATIO_SAND(3,1,I) = 0.25D0
          RATIO_SAND(4,1,I) = 0.25D0
!
!    SECOND LAYER
          RATIO_SAND(1,2,I) = 0.25D0
          RATIO_SAND(2,2,I) = 0.25D0
          RATIO_SAND(3,2,I) = 0.25D0
          RATIO_SAND(4,2,I) = 0.25D0
!
!    NOMBLAY
...
! check if fdm is according to nsicla or nsand!
...
!    FOR SEVERAL SANDS AND LAYERS.GT.2 : ELAY IS THE FIRST UPPER LAYER
        IF(NSAND.GT.1.AND.NOMBLAY.GT.1) THEN
          DO I=1,NPOIN
            ELAY%R(I)=ES(I,1)
! OPTION ELAY0 NOT CONSTANT: TO DO!
! elay0->vector ?
!            ELAY0%R(I)=ELAY%R(I)
          ENDDO
        ENDIF
