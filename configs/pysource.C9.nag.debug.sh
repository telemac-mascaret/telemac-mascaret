...
### NAG  ---------------------------------------------------------
. $SYSTEL/bin/env_nag.sh

### MPI -----------------------------------------------------------
export MPIHOME=$SYSTEL/LIBRARY/mpi/nag.5.3-bis
...
### MUMPS -------------------------------------------------------------
export MUMPSHOME=$SYSTEL/LIBRARY/mumps/nag
export SCALAPACKHOME=$SYSTEL/LIBRARY/scalapack/nag
export BLACSHOME=$SYSTEL/LIBRARY/blacs/nag
### METIS -------------------------------------------------------------
