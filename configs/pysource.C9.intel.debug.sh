...
export USETELCFG=C9.intel.debug
# Path to this file
...
### INTEL ---------------------------------------------------------
. $SYSTEL/bin/env_intel.sh
export LD_LIBRARY_PATH=$SYSTEL/lib:$LD_LIBRARY_PATH
### MPI -----------------------------------------------------------
...
### MUMPS -----------------------------------------------------------------
export MUMPSHOME=$SYSTEL/LIBRARY/mumps/intel
export SCALAPACKHOME=$SYSTEL/LIBRARY/scalapack/intel
export BLACSHOME=$SYSTEL/LIBRARY/blacs/intel
### METIS -------------------------------------------------------------
