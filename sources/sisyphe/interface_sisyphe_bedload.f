...
!
      ...
      !----------------------------------------------------------------!
!
     &(HN,Q,S,ACLADM,COEFPN,CALFA,SALFA,LIMTEC,EBOR,
     ...
     & ICLA,FLBCLA,LIQBOR,QBOR,MAXADV,MASS_SAND,RATIO_SAND,EVCL_M)
      ...
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      TYPE(BIEF_OBJ),   INTENT(IN)    :: HN,Q,S,UNSV2D,ACLADM
...
!
     ...
     &   ENTET, LCONDIS, MESH,
     &   LIEBOR, LIMTEC, MASKTR,
     &   IT1, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11,
     &   T12,T13,UNORM,AC, AT0, DTS,
...
!
      USE BIEF_DEF
      USE DECLARATIONS_SISYPHE, ONLY : NOMBLAY,MASS_SAND,NSAND,
     &                                 NUM_ICLA_ISAND
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
!
      ...
      LOGICAL,          INTENT(IN)    :: LCONDIS, SECCURRENT
      ...
      TYPE(BIEF_OBJ),   INTENT(INOUT) :: T8,T9,T10,T11,T12,T13
      DOUBLE PRECISION, INTENT(INOUT) :: AC(NSICLA), AT0, DTS
...
!
     ...
     &   THETAW, RATIO_SAND,  MASKPT, MASKEL, ACLADM, UNLADM,KSP, KSR,
     &   LIQBOR,QBOR, DEBUG, NPOIN, NPTFR, IELMT, ICF, KENT, OPTBAN,
...
!
     ...
     & ICLA,FLBCLA,RATIO_SAND,LIQBOR,QBOR,MAXADV,EVCL_M)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      TYPE(BIEF_MESH), INTENT(INOUT)  :: MESH
