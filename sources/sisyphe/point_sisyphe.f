...
!
      ...
      ALLOCATE(MASS_MUD(NPOIN,NOMBLAY,NMUD)) ! FRACTION OF EACH CLASS FOR EACH LAYER
      ALLOCATE(MASS_SAND(NPOIN,NOMBLAY,NSAND)) ! FRACTION OF EACH CLASS FOR EACH LAYER
