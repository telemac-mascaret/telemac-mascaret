...
!
!     TOTAL MASS EVOLUTION DUE TO BEDLOAD
!
      TYPE(BIEF_OBJ), TARGET :: EVOL_M
!
!     TOTAL EVOLUTION DUE TO BEDLOAD
!
...
!     POROSITE DU LIT NON-COHESIF	  
      DOUBLE PRECISION,DIMENSION(:,:),ALLOCATABLE :: XKV  
!
!-----------------------------------------------------------------------
!
!       2) MATRICES
...
!> @brief
!
!     MASS EVOLUTION FOR CLASS (DUE TO BEDLOAD, FOR THE MOMENT)
!
      TYPE(BIEF_OBJ), TARGET :: EVCL_M
!
...
!
      INTEGER NOMBSTRAT
!	  
!     NUMBER OF BED LOAD MODEL LAYERS (=NOMBSTRAT+1)
!
      INTEGER NOMBLAY
!
...
!	  
!     INITIAL POROSITY BY LAYERS (KEYWORD)
!
...
!
! ** PT **
!      DOUBLE PRECISION, TARGET :: CSF_SABLE(NLAYMAX)
...
!
!     TOTAL MASS OF SEDIMENT IN EACH CLASS
!
...
!
      DOUBLE PRECISION, TARGET :: PARTHENIADES(NLAYMAX)
!
...
!
      DOUBLE PRECISION :: CONC_MUD(NLAYMAX)
!
...
!
      DOUBLE PRECISION :: TOC_MUD(NLAYMAX),TOCE_VASE(NLAYMAX)
!
...
!
      DOUBLE PRECISION, ALLOCATABLE :: TOCD(:)
!
!     THIEBOT MODEL
!
...
!
      ...
      DOUBLE PRECISION, ALLOCATABLE :: POTFLUX_FLUSEC2(:,:)
      DOUBLE PRECISION, ALLOCATABLE :: POTVOLFLUX_FLUSEC2(:,:)

! HERE WE DECLARE HERE EXTRA DATASETUP NEEDED FOR ARTELIA BED MODEL
!
      INTEGER :: BED_MODEL
      INTEGER :: NSAND
      INTEGER :: NMUD
      ...
      DOUBLE PRECISION, ALLOCATABLE :: TOCE_MUD(:,:),TOCE_SAND(:)
!
!
