...
!
     ...
     & MAXADV)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: TOCD,VITCE,HMIN
      ...
      TYPE (BIEF_OBJ),  INTENT(INOUT) :: T9, T10, T11, T12, T14, W1, TE1
...
!
      USE BIEF
      IMPLICIT NONE
      TYPE (BIEF_OBJ),  INTENT(IN)    :: TAUP,HN,U2D,V2D,CSRATIO,T14
      INTEGER,          INTENT(IN)    :: NPOIN,DEBUG
      LOGICAL,          INTENT(IN)    :: CHARR
      DOUBLE PRECISION, INTENT(IN)    :: XMVE,XMVS,GRAV,VCE,HMIN
      DOUBLE PRECISION, INTENT(IN)    :: XWC,ZERO,AVA(NPOIN),FDM,FD90
      TYPE (BIEF_OBJ),  INTENT(IN)    :: ZREF
...
!
     ...
     & XMVE,XMVS,VCE,HMIN,XWC,TOCD,VITCE,PARTHENIADES,BILMA,MSK,
     ...
     & DIRFLU,MAXADV)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: TOCD(NSICLA), VITCE
      DOUBLE PRECISION, INTENT(IN)    :: PARTHENIADES(NOMBLAY)
