...
!
      ...
      INTEGER IPOIN,IC,IPF,NLISS,NLAYER,K,J
...
!     NOTE: NLISS NOT DEFINED, NOT USED
!
      CALL NOEROD(H%R,ZF,ZR,ZS,X,Y,NPOIN2,NLISS)
!
      IF(SEDCO) THEN
!
...
!       ZS AND NLISS ARE NOT USED IN DEFAULT NOEROD
