...
!
     ...
     & DIM1NUL,DIM2NUL,NBOR3,NELEM2,NPOIN2,NPTFR,NELEM3,NPTFR3,INFO)
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN) :: NELEM2,NPOIN2,NPTFR,NELEM3
      ...
      INTEGER, INTENT(IN) :: IKLBOR(NELEBX,4),IKLE3(NELEM3,6)
...
!
     ...
     &  NCLASS, ITRAC , ICLASS,TYPE_OF_SEDIMENT,SED_CO)
      ...
      IMPLICIT NONE
!
      INTEGER, INTENT(IN) :: NPOIN2,NPOIN3,KLOG,ICQ, ITRAC, NCLASS
      INTEGER, INTENT(IN) :: NCOUCH,ITURBV,NPLAN,ICR
      INTEGER, INTENT(IN) :: ICLASS,TYPE_OF_SEDIMENT(NCLASS)
      INTEGER, INTENT(IN) :: SED_CO
!
...
!
     ...
     & VOLU2D,V2DPAR,SETDEP,OPTSOU,ZN,OPTADV,NCO_DIST,NSP_DIST,TB2)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      ...
      TYPE(BIEF_OBJ), INTENT(INOUT)   :: T2_01,T2_02,T2_03,ZT,TB2
...
!
     ...
     &(Q,UBOR,VBOR,WBOR,U,V,NUMLIQ,NUMLIQ_ELM,IFRLIQ,T3_02,
...
!
     ...
     &  SIGMAG,IPBOT,SETDEP,OPTSOU)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: FSCE(NSCE),TETASUPG,TRAIN
...
!
     ...
     &  IND_T,IND_S,NCLASS,SED_TRA)
      ...
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN)           :: NTRAC, NCLASS,DENLAW,IND_T,IND_S
...
!
     ...
     & HMIN   , SETDEP , ICLASS,NCLASS,TYPE_OF_SEDIMENT,SED_CO)
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN) :: NPOIN3,NPOIN2,NPLAN,KLOG,SETDEP,SED_CO
      INTEGER, INTENT(IN) :: ICLASS,NCLASS,TYPE_OF_SEDIMENT(NCLASS)
...
!
     ...
     & MESH3,NELEM3,NPOIN3,IELM3,SCHCF)
      USE BIEF_DEF
      IMPLICIT NONE
...
!
     ...
     &(DIM1XB,XM,NELEM3,ELTSEG,ORISEG,FXMATPAR,NSEG3,IKLE,NPOIN3,FN,
     & FI_I,SURFAC,DFDT,TETA,ZN,ZP,SUR2VOL)
      IMPLICIT NONE
      INTEGER, INTENT(IN)             :: NELEM3,NPOIN3,NSEG3,DIM1XB
      INTEGER, INTENT(IN)             :: IKLE(NELEM3,6)
      INTEGER, INTENT(IN)             :: ELTSEG(NELEM3,15)
      INTEGER, INTENT(IN)             :: ORISEG(NELEM3,15)
      DOUBLE PRECISION, INTENT(IN)    :: XM(DIM1XB,NELEM3),TETA(NPOIN3)
...
!
     ...
     & FLBOR,PLUIE,RAIN,FLODEL,OPT_HNEG,FLULIM,YACVVF,LT,BYPASS,
     & N_ADV,WEL)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      ...
      INTEGER, INTENT(IN) :: KENT,NPTFR,GRAPRD
      ...
      TYPE(BIEF_OBJ), INTENT(INOUT) :: MASKEL,WEL,FLULIM
...
!
     ...
     & IKLE2,NELEM2,NPOIN2,NPTFR,NPLAN,NETAGE,KLOG,TRANSF)
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
...
!
     ...
     &  UETCAR,UETCAL,FICT)
      ...
      DOUBLE PRECISION, INTENT(IN) :: KMIN, KMAX, EMIN, EMAX, FICT
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
...
!
     ...
     &(ZCONV,GRAZCO,ZFLATS,DH,HN,ZF,TETAZCOMP,TETAH,NELEM2,OPTBAN,
     & IKLE2,MESH2D)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN)            :: NELEM2,OPTBAN
      INTEGER, INTENT(IN)            :: IKLE2(NELEM2,3)
...
!
     ...
     & T2_01,BEDBOU,BEDFLU,OPTADV,NCO_DIST,NSP_DIST)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: ZN(NPOIN3)
      LOGICAL, INTENT(IN)             :: MSK,INFOR,CALFLU,RAIN,BEDBOU
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
...
!
      INTERFACE
        SUBROUTINE SET_DIF
     &(FC,VOLU2D,Z,NPOIN2,NPOIN3,DT,FLUX,NPLAN,
...
!
      INTERFACE
        SUBROUTINE SUISED
     &(EPAI,HDEP,CONC,ZR,ZF,T2,NPOIN2,NCOUCH,ITASS,NSUIS,FFORMAT,PRIVE)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
...
!
     ...
     & INFOGT,SF,SM,AM2,SLVPSI,IELEM3,BB,RAIN,TRAIN,
     & PLUIE,VOLU2D,NPOIN2,OPTSOU,NSCE,ISCE,KSCE,FSCE,SOURCES,BEDBOU,
     & BEDFLU)
      USE BIEF_DEF
      IMPLICIT NONE
...
!
     ...
     &   TRAV1,TRAV2,TRAV3,S,MESH3D,IELM3,NPOIN2,NPOIN3,NPLAN,NCLASS,
     &  MSK,MASKEL,UETCAR,SED_TRA,HN,HMIN,
     ...
     & SED_CO,SED_NCO)
      ...
      DOUBLE PRECISION, INTENT(IN)  :: TURBA,TURBB,HMIN,CGEL,CINI
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
