...
!     FOR CULVERTS/TUBES/BRIDGES MANAGEMENT
      ...
      TYPE(BIEF_OBJ),TARGET :: SECBUS, LONGBUS
...
!
      DOUBLE PRECISION, ALLOCATABLE :: DEBIMP(:),COTIMP(:),VITIMP(:)
!
...
!
      DOUBLE PRECISION, ALLOCATABLE :: BETAC(:)
!
!     REFERENCE CONCENTRATION OF TRACERS
!
      DOUBLE PRECISION, ALLOCATABLE :: T0AC(:)
!
...
!
      DOUBLE PRECISION, ALLOCATABLE ::  WCHU0(:)
!
...
!
      DOUBLE PRECISION, ALLOCATABLE :: XSCE(:),YSCE(:),ZSCE(:)
!
!     VELOCITIES OF THE SOURCES ALONG X, Y
!
      DOUBLE PRECISION, ALLOCATABLE :: USCE(:),VSCE(:),WSCE(:)
!
!     WATER DISCHARGE OF SOURCES TAKEN FROM STEERING FILE
!
      DOUBLE PRECISION, ALLOCATABLE :: QSCE(:)
!
...
!
      DOUBLE PRECISION, ALLOCATABLE :: TASCE(:,:)
!
...
!     FLUX AT BOUNDARIES
!
      DOUBLE PRECISION, ALLOCATABLE :: FLUX_BOUNDARIES(:)
!
...
!
      INTEGER, PARAMETER :: MAXLU_T3D = 52
!
