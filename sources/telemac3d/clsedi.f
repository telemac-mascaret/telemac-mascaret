...
!HACK      IF(SEDCO) THEN
!HACK!
!HACK        CALL ERODC(CONC,EPAI,FLUER,TOB%R,DENSI,
!HACK     &             MPART,DT,NPOIN2,NCOUCH,TOCE,
!HACK     &             HN%R,HMIN,MIXTE,EPAICO)s
!HACK!
!HACK      ELSEIF(SEDNCO) THEN
!HACK!
!HACK        CALL ERODNC(CFDEP,WC,HDEP,FLUER,TOB,DT,
!HACK     &              NPOIN2,NPOIN3,KSPRATIO,AC,RHOS,RHO0,HN,
!HACK     &              GRAV,DMOY,CREF,ZREF,CF,ICQ,RUGOF,Z,UETCAR,
!HACK     &              SETDEP,EPAINCO,MIXTE)
!HACK!
!HACK      ELSEIF(MIXTE) THEN
!HACK!
!HACK        CALL ERODC(CONC,EPAI,FLUERC,TOB%R,DENSI,
!HACK     &             MPART,DT,NPOIN2,NCOUCH,TOCE,
!HACK     &             HN%R,HMIN,MIXTE,EPAICO)
!HACK!
!HACK        CALL ERODNC(CFDEP,WCS,HDEP,FLUERNC,TOB,DT,
!HACK     &              NPOIN2,NPOIN3,KSPRATIO,AC,RHOS,RHO0,HN,
!HACK     &              GRAV,DMOY,CREF,ZREF,CF,ICQ,RUGOF,Z,UETCAR,
!HACK     &              SETDEP,EPAINCO,MIXTE)
!HACK!
!HACK        DO IPOIN=1,NPOIN2
!HACK          FLUER(IPOIN) = FLUERNC(IPOIN) + FLUERC(IPOIN)
!HACK        ENDDO
!HACK!
!HACK      ENDIF
